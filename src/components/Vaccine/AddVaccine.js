...
export const AddVaccine = () => {
	...
	const onSubmit = async (resource) => {
		...
		} = await axios.post(`${process.env.REACT_APP_BASE_URL}/vaccine/add`, {
			...resource,
			addedBy,
		});
		!success &&
			...
			<div>
				...
				<div className="admin-wrapper col-12">
					<div className="admin-content">
						<div className="admin-head">Vaccine - Add New</div>
											...
											<div className="row m-0">
												<div className="col-lg-12 p-0">
													<div className="form-group tags-field row m-0">
														<label className="col-lg-2 p-0">Vaccine Name</label>
														<Field
