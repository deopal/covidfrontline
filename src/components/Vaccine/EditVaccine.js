...
export const EditVaccine = (props) => {
	...
	const [vaccine, setVaccine] = useState(initialValues);
	const getVaccine = () => {
		axios
			.get(
	...
	const onSubmit = async (resource) => {
		const {
			...
			`${process.env.REACT_APP_BASE_URL}/vaccine/update/${props.match.params._id}`,
			{
				...resource,
				addedBy,
			}
			...
			<div>
				...
				<div className="admin-wrapper col-12">
					<div className="admin-content">
						<div className="admin-head">Vaccine - Edit</div>
						<div className="admin-data">
							...
							<div className="container-fluid p-0">
								{loading ? (
									...
									<Formik
										initialValues={vaccine || initialValues}
