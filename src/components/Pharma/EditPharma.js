...
export const EditPharma = (props) => {
	...
	const [pharma, setPharma] = useState(initialValues);
	const getPharma = () => {
		axios
			.get(
	...
	const onSubmit = async (resource) => {
		const {
			...
			`${process.env.REACT_APP_BASE_URL}/pharma/update/${props.match.params._id}`,
			{
				...resource,
				addedBy,
			}
			...
			<div>
				...
				<div className="admin-wrapper col-12">
					<div className="admin-content">
						<div className="admin-head">Pharma - Edit</div>
						<div className="admin-data">
							...
							<div className="container-fluid p-0">
								{loading ? (
									...
									<Formik
										initialValues={pharma || initialValues}
