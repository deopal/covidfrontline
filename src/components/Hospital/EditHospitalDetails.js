...
export const EditHospitalDetails = (props) => {
	const {
		user: { _id: addedBy },
	} = isAutheticated();
	...
	const [hospitalResources, setHospitalResources] = useState(initialValues);
	...
	const onSubmit = async (resource) => {
		const {
			...
			`${process.env.REACT_APP_BASE_URL}/hospitaldetails/update/${props.match.params._id}`,
			{
				...resource,
				addedBy,
			}
		...
		success &&
			swal({
				title: "Saved",
				text: "Hospital Resources Saved.Redirecting to the Hospital Resources",
				icon: "success",
				timer: 2000,
			}).then(() => {
			...
			<div>
				...
				<div className="admin-wrapper col-12">
					<div className="admin-content">
						<div className="admin-head">Hospital Details - Edit</div>
						<div className="admin-data">
							...
							<div className="container-fluid p-0">
								{loading ? (
									...
									<Formik
										initialValues={hospitalResources || initialValues}
